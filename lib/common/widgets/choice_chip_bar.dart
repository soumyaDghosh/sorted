...
class CustomYaruChoiceChipBar extends StatefulWidget {
  const CustomYaruChoiceChipBar({
    super.key,
  ...
  /// If [onSelected] is null, the whole [CustomYaruChoiceChipBar] is disabled.
  ...
  /// Flag to select if the selected chip will be shown before the unselected ones
  /// Defaults to `true`.
  final bool preferSelected;

  @override
  State<CustomYaruChoiceChipBar> createState() => _YaruChoiceChipBarState();
}

class _YaruChoiceChipBarState extends State<CustomYaruChoiceChipBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final children = widget.preferSelected
        ? [
